            ...
            <div className="Pagar__total">
              ...
              <div className="Pagar__total__ubicacion">
                ...
                >
                  ...
                  <option value="Cartagena del Chairá">
                  ...
                  <option value="El Carmen de Atrato">
                    El Carmen de Atrato
                  </option>
                  <option value="El Carmen de Bolívar">
                    El Carmen de Bolívar
                  </option>
                  <option value="El Carmen de Chucurí">
                  ...
                  <option value="Guayabal de Siquima">
                    Guayabal de Siquima
                  </option>
                  ...
                  <option value="Sabanalarga">Sabanalarga</option>
                  <option value="Sabanalarga">Sabanalarga</option>
                  <option value="Sabanas de San Angel">
                  ...
                  <option value="San Andrés">San Andrés</option>
                  <option value="San Andrés">San Andrés</option>
                  <option value="San Andrés Sotavento">
                  ...
                  <option value="San Carlos">San Carlos</option>
                  <option value="San Carlos de Guaroa">
                  ...
                  <option value="San Pablo">San Pablo</option>
                  <option value="San Pablo de Borbur">
                    San Pablo de Borbur
                  </option>
                  <option value="San Pedro">San Pedro</option>
                  <option value="San Pedro">San Pedro</option>
                  <option value="San Pedro">San Pedro</option>
                  <option value="San Pedro de Cartago">
                  ...
                  <option value="Santafé de Antioquia">
